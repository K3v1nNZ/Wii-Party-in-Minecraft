...
vec4(0.6176094198, 0.201489598, 0.7008333842, 1.0),
vec4(0.9764705882, 0.2392156863, 0.6745098039, 1.0),
vec4(1.0, 0.8225, 0.973375, 1.0)
);
#define block_ANIM_SPEED 500
#define block_COLOUR_PERIOD 4
...
vec4(0.3411764706, 1.0, 0.8823529412, 1.0)
);
