...
execute as @a[tag=ingame] run attribute @s generic.jump_strength base set 3999999999999
execute as @a[tag=ingame] run attribute @s generic.gravity base set 50999999999999
