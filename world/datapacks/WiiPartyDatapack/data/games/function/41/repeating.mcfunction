...
# Crouch detection
# Unset barrier
execute as @a[tag=ingame,scores={41jump=1..}] run attribute @s generic.gravity base set 0.1
...
execute as @e[type=item_display,tag=41stand,tag=blue] at @s unless entity @a[dx=0,dy=3,dz=0,team=blue] run tp @a[tag=ingame,team=blue] ~ ~1 ~
execute as @e[type=item_display,tag=41stand,tag=red] at @s unless entity @a[dx=0,dy=3,dz=0,team=red] run tp @a[tag=ingame,team=red] ~ ~1 ~
execute as @e[type=item_display,tag=41stand,tag=green] at @s unless entity @a[dx=0,dy=3,dz=0,team=green] run tp @a[tag=ingame,team=green] ~ ~1 ~
execute as @e[type=item_display,tag=41stand,tag=orange] at @s unless entity @a[dx=0,dy=3,dz=0,team=orange] run tp @a[tag=ingame,team=orange] ~ ~1 ~