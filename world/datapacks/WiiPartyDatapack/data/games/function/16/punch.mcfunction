...
scoreboard players set maxDelta= 16scores 75
...
execute if score hit= 16scores matches 0 at @s anchored eyes positioned ^ ^ ^ anchored feet rotated ~ 0 positioned ^ ^ ^-0.25 run function games:16/check_hit
execute if score hit= 16scores matches 0 at @s anchored eyes positioned ^ ^ ^ anchored feet rotated ~ 0 positioned ^.33 ^ ^-0.25 run function games:16/check_hit
execute if score hit= 16scores matches 0 at @s anchored eyes positioned ^ ^ ^ anchored feet rotated ~ 0 positioned ^-.33 ^ ^-0.25 run function games:16/check_hit
