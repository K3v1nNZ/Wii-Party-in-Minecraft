...
execute as @a[tag=ingame,team=green] if score @s 36furthest matches 3 run team modify displayline5 prefix {"bold":true,"translate":"scoreboard.FaceFlip","with":[{"translate":"scoreboard.FaceFlip.Symbol","color":"green"},{"translate":"scoreboard.FaceFlip.Symbol","color":"green"},{"translate":"scoreboard.FaceFlip.Symbol","color":"green"}]}
    # Orange team
execute as @a[tag=ingame,team=orange] if score @s 36furthest matches 0 run team modify displayline2 prefix {"bold":true,"translate":"scoreboard.FaceFlip","with":[{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"}]}
execute as @a[tag=ingame,team=orange] if score @s 36furthest matches 1 run team modify displayline2 prefix {"bold":true,"translate":"scoreboard.FaceFlip","with":[{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"}]}
execute as @a[tag=ingame,team=orange] if score @s 36furthest matches 2 run team modify displayline2 prefix {"bold":true,"translate":"scoreboard.FaceFlip","with":[{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gray"}]}
execute as @a[tag=ingame,team=orange] if score @s 36furthest matches 3 run team modify displayline2 prefix {"bold":true,"translate":"scoreboard.FaceFlip","with":[{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"},{"translate":"scoreboard.FaceFlip.Symbol","color":"gold"}]}