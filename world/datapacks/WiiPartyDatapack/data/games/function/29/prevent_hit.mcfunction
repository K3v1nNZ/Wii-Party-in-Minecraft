tag @s add 29temp
execute if entity @s[team=!blue] as @p[tag=ingame] if entity @s[team=blue,tag=29stunned] run say fuck
execute if entity @s[team=!blue] as @p[tag=ingame] if entity @s[team=blue,tag=29stunned] run team join blue @n[tag=29temp]
execute if entity @s[team=!red] as @p[tag=ingame] if entity @s[team=red,tag=29stunned] run say fuck
