...
# Posing
execute if score ingame= 21scores matches 2 as @e[type=armor_stand,tag=21person] if score @s 21poseTime matches 0.. run function games:21/posing

execute if score ingame= 21scores matches 0..2 run tp @a[tag=playing] 30063 12 29993 90 0

# Scroll zooming
execute as @a[tag=ingame] run function games:21/zoom_check
# Title for scrolling
...
# Camera overla
execute if score ingame= 21scores matches 2 as @a[team=blue,tag=ingame] at @s run function games:38/overlay/blue/4
execute if score ingame= 21scores matches 2 as @a[team=red,tag=ingame] at @s run function games:38/overlay/red/4
execute if score ingame= 21scores matches 2 as @a[team=green,tag=ingame] at @s run function games:38/overlay/green/4
execute if score ingame= 21scores matches 2 as @a[team=orange,tag=ingame] at @s run function games:38/overlay/orange/4
...
# Take Photo
execute as @a[tag=ingame] if score @s rightClick matches 1.. run function games:21/photo_take