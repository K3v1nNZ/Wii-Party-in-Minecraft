data modify storage minecraft:game38 display set from storage minecraft:game38 red[0]
data remove storage minecraft:game38 red[0]
...
execute store success score continue= 38scores run data modify storage minecraft:game38 temp set from storage minecraft:game38 red
data remove storage minecraft:game38 temp

execute if score continue= 38scores matches 1 run title @a[tag=playing] actionbar {"nbt":"colors.red","storage":"minecraft:config","interpret":true,"extra":[{"selector":"@a[team=red]","type":"selector"},": ",{"score":{"name":"correct=","objective":"38scores"},"type":"score"},{"text":"/","type":"text"},{"score":{"name":"total=","objective":"38scores"},"type":"score"}],"source":"storage","type":"nbt"}
