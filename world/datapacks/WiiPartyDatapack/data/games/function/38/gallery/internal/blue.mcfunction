...
execute if score continue= 38scores matches 1 run schedule function games:38/gallery/internal/blue 1s
execute if score continue= 38scores matches 0 run schedule function games:38/gallery/red 3s