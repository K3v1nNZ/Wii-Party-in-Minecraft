...
# Not Double
execute unless score double= dice matches 1 as @a[tag=turn,tag=1st] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResult","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"golden=","objective":"dice"},"color":"#FF20FF"}],"color":"#FF18FF"}]
execute unless score double= dice matches 1 as @a[tag=turn,tag=2nd] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResult","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"silver=","objective":"dice"},"color":"#FF24FF"}],"color":"#FF18FF"}]
execute unless score double= dice matches 1 as @a[tag=turn,tag=3rd] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResult","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"bronze=","objective":"dice"},"color":"#FF28FF"}],"color":"#FF18FF"}]
execute unless score double= dice matches 1 as @a[tag=turn,tag=4th] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResult4th","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"}],"color":"#FF18FF"}]
# Double
execute if score double= dice matches 1 as @a[tag=turn,tag=1st] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResultDouble","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"golden=","objective":"dice"},"color":"#FF20FF"},{"score":{"name":"doubleroll=","objective":"dice"},"color":"#FF1CFF"}],"color":"#FF18FF"}]
execute if score double= dice matches 1 as @a[tag=turn,tag=2nd] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResultDouble","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"silver=","objective":"dice"},"color":"#FF24FF"},{"score":{"name":"doubleroll=","objective":"dice"},"color":"#FF1CFF"}],"color":"#FF18FF"}]
execute if score double= dice matches 1 as @a[tag=turn,tag=3rd] run title @a[tag=playing] subtitle [{"translate":"board.DiceRoll.RollResultDouble","with":[{"selector":"@s","color":"#FF18FF"},{"score":{"name":"normal=","objective":"dice"},"color":"#FF1CFF"},{"score":{"name":"bronze=","objective":"dice"},"color":"#FF28FF"},{"score":{"name":"doubleroll=","objective":"dice"},"color":"#FF1CFF"}],"color":"#FF18FF"}]
