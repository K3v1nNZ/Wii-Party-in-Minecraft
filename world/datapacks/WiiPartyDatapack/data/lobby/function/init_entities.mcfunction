...
summon text_display -552.0 15 530.0 {shadow:1b,alignment:"center",Tags:["lobbyMain"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2.5f,2.5f,2.5f]},text:'{"translate":"lobby.Translations.Header","color":"#f2a058"}',background:-2113929216,Rotation:[-20f,0f]}
